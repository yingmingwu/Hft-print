...
//		}
//	}
	public static byte[] POS_Print_Text(int paramInt, String paramString1, String paramString2)
	{
		if ((paramInt < 0) || (paramInt > 255) || (paramString1 == null) || ("".equals(paramString1)) || (paramString1.length() < 1))
			return null;
		byte[] arrayOfByte;
		try
		{
			arrayOfByte = paramString1.getBytes(paramString2);
			Command.ESC_t[2] = ((byte)paramInt);
			if (paramInt == 0)
			{
				byte[][] arrayOfByte2 = new byte[3][];
				arrayOfByte2[0] = Command.ESC_t;
				arrayOfByte2[1] = Command.FS_and;
				arrayOfByte2[2] = arrayOfByte;
				return Other.byteArraysToBytes(arrayOfByte2);
			}
		}
		...
		arrayOfByte1[0] = Command.ESC_t;
		arrayOfByte1[1] = Command.FS_dot;
		arrayOfByte1[2] = arrayOfByte;
		return Other.byteArraysToBytes(arrayOfByte1);
	}
